...
class OrderResourceIT {
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getAmount()).isEqualByComparingTo(DEFAULT_AMOUNT);
    ...
    void putExistingOrder() throws Exception {
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getAmount()).isEqualByComparingTo(UPDATED_AMOUNT);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.amount(UPDATED_AMOUNT).paymentMethod(UPDATED_PAYMENT_METHOD).comment(UPDATED_COMMENT);
